...
- The native capture loop saves overlapping keyframes after measured camera translation or orientation change; the web scanner has the richer adaptive coverage guidance for ordinary-camera scans.
